...
//    HAL_TIM_Base_Start_IT(&htim9);
  ...
  HAL_GPIO_WritePin(OUT21_GPIO_Port, OUT21_Pin, GPIO_PIN_RESET);
  ...
  logLen = (uint8_t)sprintf(log, "encoder = %d\n", encoder);
  HAL_UART_Transmit(&huart3, (uint8_t*)log, logLen, 100);
  ...
  while (1)
  {
    ...
    logLen = (uint8_t)sprintf(log, "encoder = %d\n", encoder/4);
    HAL_UART_Transmit(&huart3, (uint8_t*)log, logLen, 100);
    HAL_UART_Transmit(&huart1, (uint8_t*)log, logLen, 100);
    }
